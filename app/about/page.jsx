				...
				<div className="relative h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
					<div className="z-0 mb-48 md:mb-0  md:absolute top-1/4  md:right-[10%] md:-translate-y-16 ">
						<motion.div
							...
							className="bg-slate-300 rounded-sm h-[400px] md:h-[600px] w-[80vw] md:w-[30vw] hover:grayscale-0 ">
							<Image
								src={Me2}
								alt="Maximiliens"
								layout="fill"
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					<div className="flex justify-center items-start flex-col mb-5 ">
						<div className="images relative w-full  aspect-square">
							<div className="absolute top-28 left-10 w-[50%]  aspect-square hover:grayscale-0 transition-all ease duration-300">
								<motion.div
							...
							<div className="absolute top-16 right-28 w-[30%]  aspect-square hover:grayscale-0 transition-all ease duration-300">
								<motion.div
									initial={{
										opacity: 0,
										scale: 0.5,
							...
							<div className="absolute bottom-16 right-20 w-[40%]  aspect-square hover:grayscale-0 transition-all ease duration-300">
								<motion.div
									initial={{
										opacity: 0,
										scale: 0.5,
					...
					<p className="text-gray-600 text-justify title text-lg">
						Hey there, I&rsquo;m Maximilien Menesguen, a
						...
						Based in Paris, France, I am currently pursuing a double master&rsquo;s degree at{" "}
						<span className="text-black font-medium">
							ESILV | Paris La Défense,
						</span>{" "}
						specializing in{" "}
						<span className="text-black font-medium">
							Creative Technology and Science.
						</span>{" "}
						My journey revolves around developing innovative systems, from creating 3D digital twins of drone swarms to designing and racing DIY FPV drones. My passion extends to automation, robotics, and sensor technologies, combining technical expertise with creativity. Beyond engineering, I love building and repairing gas-powered miniature cars and exploring the world through cultural travel. I&rsquo;m a firm believer in
						<span className="text-black font-medium">
							{" "}
							hands-on learning
						</span>{" "}
						and staying curious in this ever-evolving technological landscape. Let&rsquo;s connect and innovate together!
					</p>
